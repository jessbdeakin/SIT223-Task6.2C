	...
	stages {
		...
		stage('Unit and Integration Tests') {
			steps {
				...
				mail to: "${EMAIL_ADDRESS}", subject: "[JENKINS] Successful test", body: "The testing was successful."
			}
			post {
				failure {
					mail to: "${EMAIL_ADDRESS}", subject: "[JENKINS] Failed test", body: "The testing failed."
				}
			}
		}
		...
		stage('Security Scan'){
			steps {
				...
				mail to: "${EMAIL_ADDRESS}", subject: "[JENKINS] Successful security scan", body: "The security scan was successful."
			}
			post {
				failure {
					mail to: "${EMAIL_ADDRESS}", subject: "[JENKINS] Failed security scan", body: "The security scan failed."
				}
			}
		}
